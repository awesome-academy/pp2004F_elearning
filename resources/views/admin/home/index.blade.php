            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="m-t-10">
                                <canvas class="chart" id="customer-overview-chart"
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p><span class="text-info text-semibold font-size-15">1.5%</span> services charge
                                per sales</p>
                            ...
                            <ul class="list-unstyled">
                                <li class="p-v-15 border bottom">
                                    <a href="#">
                                        <div class="media">
                                            <div class="m-r-20">
                                                <img class="img-fluid" src="assets/images/others/img-35.jpg"
                                                     alt="">
                                            </div>
                                            <div>
                                                <h5 class="text-link text-semibold m-b-0 m-t-5">Team
                                                    Gathering</h5>
                                ...
                                <li class="p-v-15">
                                    <a href="#">
                                        <div class="media">
                                            <div class="m-r-20">
                                                <img class="img-fluid" src="assets/images/others/img-34.jpg"
                                                     alt="">
                                            </div>
                                            <div>
                                                <h5 class="text-link text-semibold m-b-0 m-t-5">Video
                                                    Conference</h5>
